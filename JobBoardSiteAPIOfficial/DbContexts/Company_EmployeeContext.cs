...
namespace JobBoardSiteAPIOfficial.DbContexts
{
    ...
    public class Company_EmployeeContext : DbContext
    {
        public DbSet<Company_Employee> Employees { get; set; }

        static readonly string connectionString = "Server=localhost; User ID=root; Password=password; Database=job_board_schema";

        public Company_EmployeeContext(DbContextOptions<Company_EmployeeContext> options) : base(options)
        {
